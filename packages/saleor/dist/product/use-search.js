...
export const handler = {
    ...
    async fetcher ({ input , options , fetch  }) {
        ...
        if (categoryId) {
            var ref, ref1;
            edges = (data == null ? void 0 : (ref = data.collection) == null ? void 0 : (ref1 = ref.products) == null ? void 0 : ref1.edges) ?? [];
        ...
        // }
            ...
            var ref2;
            edges = (data == null ? void 0 : (ref2 = data.products) == null ? void 0 : ref2.edges) ?? [];
        }
        return {
